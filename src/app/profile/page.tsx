            ...
            <div className='w-full md:w-1/2'>
                <div className='md:w-full lg:w-3/4  flex flex-col'>
                    <form className='w-full px-2'>
                        <Input placeholder={"John Deo"} label={"username"} type={"text"} inputName={"username"} />
                        <Input placeholder={"email@example.com"} label={"email"} type={"email"} inputName={"email"} />
                        <Input placeholder={"password"} label={"password"} type={"password"} inputName={"password"} />
